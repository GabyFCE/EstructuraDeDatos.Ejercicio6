...
{
    internal static class FacturaArchivo
    {
        ...
        */
        ...
        static List<FacturaEnt> facturas;
        ...
        static FacturaArchivo()
        {
            //si existe el archivo...
            if (File.Exists("facturas.json"))
            {
                //lee TODO el contenido del archivo.
                string contenidoDelArchivo = File.ReadAllText("facturas.json");

                //esta linea convierte el texto
                //de vuelta a objetos de tipo PersonaEnt;

                facturas = JsonConvert.DeserializeObject<List<FacturaEnt>>(contenidoDelArchivo);
            }
            else
            {
        ...
        public static List<FacturaEnt> ObtenerFacturas()
        {
            return facturas.ToList();
        }


        public static void AgregarFactura(FacturaEnt factura)
        {
            facturas.Add(factura);
        }

        public static void AgregarListaFacturas(List<FacturaEnt> productosNuevos)
        {
            facturas.Concat(productosNuevos);
        }
        ...
        */
        ...
        {
            var contenido = JsonConvert.SerializeObject(facturas);
            File.WriteAllText("facturas.json", contenido);
        }
    }
}
